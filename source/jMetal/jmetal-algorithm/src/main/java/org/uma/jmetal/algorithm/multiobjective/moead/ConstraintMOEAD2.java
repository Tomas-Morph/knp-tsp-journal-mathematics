...
public class ConstraintMOEAD2<S extends Solution<?>> extends AbstractMOEAD<S> {
...
//  protected SinglePointCrossover singlePointCrossover;
  ...
  public ConstraintMOEAD2(Problem<S> problem,
      int populationSize,
    ...
    violationThresholdComparator = new ViolationThresholdComparator<S>() ;
  }	
